...
<div class="container-fluid">
    <div class="row m-2 mt-5 p-0  text-center">
        <!-- <div class="col-4 shadow py-4 ">
            <img src="./Product-Image/ $res['photo'] ?>"
        ...
        <div class="col-8 shadow py-3 px-5 ">
            ...
            <div class="text-center">
                <a href="add-to-cart.php?id=<?php echo $res['product_id'] ?>" class="btn btn-default add-to-cart text-center">
