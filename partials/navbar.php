...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex align-items-center">
            <!-- Icon -->
            <li>
                <a href="cart.php"><i class="fa fa-shopping-cart " style="color:blue;"></i> <span class="cart-count me-2"><?php echo $total ?? ''  ?></span> </a>
            </li>
            <!-- Notifications -->
            <div class="dropdown">
            ...
            <div class="dropdown">
                <a class="dropdown-toggle d-flex align-items-center hidden-arrow" href="#" id="navbarDropdownMenuAvatar" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
                    ...
                    <?php if ($photo) : ?>
                        <img src="./Image/<?= $_SESSION['photo']; ?>" class="rounded-circle" width="25" height="25" alt="Black and White Portrait of a Man" loading="lazy" />
                    <?php else : ?>
                        <img src="./img/2.webp" class="rounded-circle" height="25" alt="Black and White Portrait of a Man" loading="lazy" />
                    <?php endif ?>
