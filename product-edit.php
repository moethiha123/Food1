...
<div class="main p-5 ">
    <form action="product-update.php" class="w-50 m-auto p-5 m-5 shadow" method="post" enctype="multipart/form-data">
        ...
        <!-- <div class="mb-3">
            <input type="text" placeholder="Category Id.." name="category_id" value="<?= $product['category_id'] ?>"
                class="form-control">
        </div> -->
        <input type="hidden" name="product_id" value="<?= $product['product_id'] ?>">
        <div class="mb-3">
            <select name="category_id" class="form-control">
                <!-- <option value="" name="name" disabled selected>Select Category Name</option> -->
                <?php
        ...
        <?= $product['description'] ?>
            ...
            <div class="mb-3">
                <img src="Image/<?= $product['photo'] ?>" width="160" height="200" style="object-fit:cover;object-fit:contain;" alt="user">
